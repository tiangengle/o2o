...
public class ProductDaoTest extends BaseTest {
	...
	public void testCQueryProductByProductId() throws Exception {
		long productId = 1;
		//初始化两个商品详情图实例作为ProductId为 1 的商品下的详情图片
		//批量插入到详情图表中
		...
		//查询productId为 1 的商品信息并校验返回的详情图实例列表size是否为2
	...
	public void testEUpdateProductCategoryToNull(){
		//将productCategoryId 为 2 的商品类别下面的商品的商品类别置为空
	...
	public void testFDeleteShopAuthMap() throws Exception {
		int effectedNum = productDao.deleteProduct(2, 3);
		assertEquals(1, effectedNum);
	}
}
